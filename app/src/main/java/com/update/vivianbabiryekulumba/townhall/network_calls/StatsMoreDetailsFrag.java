 ...
 */
public class StatsMoreDetailsFrag extends Fragment {

    private static final String TAG = "StatMore";
    private RecyclerView recyclerView;
    private List<CommBoard> moreDetailsList;
    Context context;

    public StatsMoreDetailsFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_stats_more_details, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_more_stat);
