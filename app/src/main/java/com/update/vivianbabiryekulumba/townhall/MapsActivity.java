...
public class MapsActivity extends AppCompatActivity {
    ...
    public void servicesOk() {
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(MapsActivity.this, available, ERROR_DIALOG_REQEUST);
            dialog.show();
        }
    }
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            if (currentLocation == null) {
                                Toast.makeText(MapsActivity.this, "GPS is not on, please turn on GPS!", Toast.LENGTH_SHORT).show();
