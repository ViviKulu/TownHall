 ...
 */
public class QuMoreDetailsFrag extends Fragment {

    private static final String TAG = "QuMore";
    private RecyclerView recyclerView;
    private List<CommBoard> moreDetailsList;
    Context context;

    public QuMoreDetailsFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_qu_more_details, container, false);
        recyclerView = view.findViewById(R.id.recyclerview_more_qu);
