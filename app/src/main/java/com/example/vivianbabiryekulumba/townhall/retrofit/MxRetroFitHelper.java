...
public class MxRetroFitHelper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mx_retro_fit_helper);
        recyclerView = findViewById(R.id.recyclerviewMx);
