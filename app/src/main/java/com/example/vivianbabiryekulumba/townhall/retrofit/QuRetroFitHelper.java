...
public class QuRetroFitHelper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qu_retro_fit_helper);

        recyclerView = findViewById(R.id.recyclerviewQu);
