...
public class BxRetroFitHelper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bx_retro_fit_helper);

        recyclerView = findViewById(R.id.recyclerviewBx);
