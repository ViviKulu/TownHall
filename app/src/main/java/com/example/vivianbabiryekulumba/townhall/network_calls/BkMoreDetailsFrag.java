 ...
 */
public class BkMoreDetailsFrag extends Fragment {

    private static final String TAG = "BkMore";
    private RecyclerView recyclerView;
    private List<CommBoard> moreDetailsList;
    Context context;

    public BkMoreDetailsFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bk_more_details, container, false);

        recyclerView = view.findViewById(R.id.recyclerview_more_bk);
